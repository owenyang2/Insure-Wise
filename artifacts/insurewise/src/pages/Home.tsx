            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                  <Link
                    href="/onboard"
                    className="w-full sm:w-auto px-8 py-4 rounded-lg bg-primary text-primary-foreground font-semibold text-lg flex items-center justify-center gap-2 shadow-xl shadow-primary/25 hover:shadow-2xl hover:shadow-primary/30 hover:-translate-y-1 transition-all duration-300"
                  >
                    ./start-consultation
                  ...
                  <Link
                    href="/compare"
                    className="w-full sm:w-auto px-8 py-4 rounded-lg bg-card text-foreground font-semibold text-lg flex items-center justify-center gap-2 border border-border hover:border-primary/50 hover:bg-primary/5 transition-all duration-300 shadow-sm"
                  >
                    ls policies/
                  </Link>
                </div>
            ...
            <div className="grid md:grid-cols-3 gap-12 max-w-5xl mx-auto">
              {[
                ...
                <motion.div
                  ...
                  className="bg-background rounded-2xl p-8 border border-border shadow-lg shadow-black/20 hover:shadow-xl hover:border-primary/30 transition-all duration-300"
                >
